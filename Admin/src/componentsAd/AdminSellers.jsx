...
useEffect(()=>{
    axios.get('http://localhost:3000/allSeller').then((res)=>{setSels(res.data)})
...
const deleteSeller = (UserId) => {
 ...
 return(
    <div>
        ...
        <div className='flex justify-center align-middle bg-red text-white h-20 gap-40 mb-6 items-center' >
       ...
       <div>
        ...
        <br/>
        <DeleteIcon onClick={()=> {deleteSeller(el.id)}} /> 
